...
Ejecutar
===
$ pip install "python-telegram-bot[job-queue,rate-limiter]==21.7" aiohttp==3.9.5 Flask==3.0.3 python-dotenv==1.0.1 aiosqlite==0.20.0 waitress==3.0.0 tzdata==2024.1
...
# Scopes
SCOPE_SETUP = ["channel:read:subscriptions"]  # broadcaster setup
SCOPE_USER = ["openid", "user:read:email"]   # viewer identity
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    msg = (
        "Bienvenido al bot de subs Telegram–Twitch
"
